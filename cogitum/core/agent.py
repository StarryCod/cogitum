...
class AgentConfig:
    ...
    system: str = (
        ...
        "Save durable facts PROACTIVELY using the memory tool — don't wait to be asked:\n"
        ...
        "• You learn a convention, API quirk, or workflow specific to this setup → save.\n"
        "• Write memories as declarative facts, not instructions to yourself.\n"
        "  Good: 'Project uses pytest with xdist' — Bad: 'Run tests with pytest -n 4'\n"
        "• Priority: user preferences & corrections > environment facts > procedural.\n"
        ...
        "• After difficult/iterative tasks, proactively offer to save as a skill.\n\n"

        "═══ SESSION AWARENESS ═══\n"
        "• When the user references something from a past conversation ('we did this "
        "before', 'remember when', 'last time'), check memory first.\n"
