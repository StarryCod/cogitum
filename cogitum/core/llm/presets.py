...
PROVIDER_PRESETS: tuple[ProviderPreset, ...] = (
    ...
    ProviderPreset(
        ...
        models=(
            # Verified Cerebras-served models as of 2026
            ModelPreset("llama3.1-8b", "Llama 3.1 8B",
                        ("cb-llama-8b",), ("text", "tools"),
                        128_000, 8_000),
            ModelPreset("llama-3.3-70b", "Llama 3.3 70B",
                        ("cb-llama-70b",), ("text", "tools"),
                        128_000, 8_000),
            ModelPreset("llama-4-scout-17b-16e-instruct",
                        "Llama 4 Scout 17B",
                        ("cb-scout",),
                        ("text", "vision", "tools"), 128_000, 8_000),
            ModelPreset("llama-4-maverick-17b-128e-instruct",
                        "Llama 4 Maverick 17B",
                        ("cb-maverick",),
                        ("text", "vision", "tools"), 128_000, 8_000),
            ModelPreset("qwen-3-32b", "Qwen 3 32B",
                        ("cb-qwen3-32b",), ("text", "tools"),
                        128_000, 16_000),
            ModelPreset("qwen-3-235b-a22b-instruct-2507",
                        "Qwen 3 235B Instruct",
                        ("cb-qwen3-235",), ("text", "tools"),
                        128_000, 32_000),
            ModelPreset("qwen-3-235b-a22b-thinking-2507",
                        "Qwen 3 235B Thinking",
                        ("cb-qwen3-thinking",),
                        ("text", "reasoning", "tools"),
                        128_000, 32_000),
            ModelPreset("qwen-3-coder-480b", "Qwen 3 Coder 480B",
                        ("cb-coder",), ("text", "tools"),
                        128_000, 32_000),
