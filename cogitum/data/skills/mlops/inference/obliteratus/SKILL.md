...
Walkthrough of OBLITERATUS used by a Cogitum agent to abliterate Gemma:
...
See `skills(name="obliteratus", file_path="references/analysis-modules.md")` for the full reference.
...
Load templates for reproducible runs via `skills`:
