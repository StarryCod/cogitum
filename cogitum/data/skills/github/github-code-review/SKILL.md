...
```bash
source "${HERMES_HOME:-$HOME/.cogitum}/skills/github/github-auth/scripts/gh-env.sh"
...
gh pr review $PR_NUMBER --approve --body "Reviewed by Cogitum. Code looks clean — good test coverage, no security concerns."
