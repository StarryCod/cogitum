...
```python
import sys
sys.path.insert(0, "~/.config/cogitum/skills/creative/pixel-art/scripts")
...
```bash
cd ~/.config/cogitum/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Cogitum installs package this)
