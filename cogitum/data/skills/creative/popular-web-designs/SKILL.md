...
version: 1.0.0
author: Cogitum + Teknium (design systems sourced from VoltAgent/awesome-design-md)
license: MIT
...
2. Load it: `skills(name="popular-web-designs", file_path="templates/<site>.md")`
3. Use the design tokens and component specs when generating HTML
4. Pair with the `generative-widgets` skill to serve the result via cloudflared tunnel

Each template includes a **Cogitum Implementation Notes** block at the top with:
...
<head>
  ...
  <!-- Paste the Google Fonts <link> from the template's Cogitum notes -->
